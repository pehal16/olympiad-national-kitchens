...
test("PM01 student UI gives clear action steps for interactive tasks", () => {
  ...
  assert.equal(uiHtml.includes("id=\"result-digital-shift\""), true);
  ...
  assert.equal(uiStyles.includes(".digital-shift-cockpit-action"), true);
  assert.equal(uiStyles.includes(".digital-shift-cockpit-focus"), true);
  assert.equal(uiStyles.includes(".digital-shift-progress"), true);
  assert.equal(uiStyles.includes(".digital-shift-open-action"), true);
  assert.equal(uiStyles.includes(".digital-shift-complete-action"), true);
  assert.equal(uiStyles.includes(".digital-shift-task-open"), true);
  assert.equal(uiStyles.includes(".digital-shift-mini-family"), true);
  assert.equal(uiStyles.includes(".result-digital-shift"), true);
  assert.equal(uiStyles.includes(".result-digital-shift-list"), true);
  assert.equal(uiStyles.includes(".digital-shift-cockpit-zones span.is-active"), true);
  assert.equal(uiStyles.includes(".digital-shift-task.is-active"), true);
  assert.equal(uiStyles.includes(".digital-shift-task.is-complete"), true);
  assert.equal(uiStyles.includes(".production-log-list li.is-complete"), true);
  assert.equal(uiStyles.includes(".production-log-list li.is-active"), true);
  ...
  assert.equal(uiStyles.includes(".approval-gate-panel"), true);
  assert.equal(uiStyles.includes(".approval-gate-card"), true);
  assert.equal(uiStyles.includes(".approval-action-plan"), true);
  assert.equal(uiStyles.includes(".approval-action-card"), true);
  assert.equal(uiStyles.includes(".approval-rp-request-kit"), true);
  assert.equal(uiStyles.includes(".approval-rp-request-card"), true);
  assert.equal(uiStyles.includes(".approval-rp-request-package"), true);
  ...
  assert.equal(uiStyles.includes(".approval-connection-implementation"), true);
  assert.equal(uiStyles.includes(".approval-connection-implementation-actions"), true);
  assert.equal(uiStyles.includes(".approval-connection-implementation-card"), true);
  assert.equal(uiStyles.includes(".approval-connection-implementation-status"), true);
  assert.equal(uiStyles.includes(".approval-connection-file-check"), true);
  assert.equal(uiStyles.includes(".approval-connection-readiness"), true);
  assert.equal(uiStyles.includes(".approval-connection-readiness-summary"), true);
  ...
  assert.equal(uiStyles.includes(".approval-coverage-package"), true);
  assert.equal(uiStyles.includes(".approval-competency-review"), true);
  assert.equal(uiStyles.includes(".approval-competency-review-card"), true);
  assert.equal(uiStyles.includes(".approval-competency-review-button"), true);
  assert.equal(uiStyles.includes(".approval-innovation-review"), true);
  assert.equal(uiStyles.includes(".approval-innovation-review-card"), true);
  assert.equal(uiStyles.includes(".approval-innovation-review-button"), true);
  assert.equal(uiStyles.includes(".approval-inspection-panel"), true);
  assert.equal(uiStyles.includes(".approval-inspection-card"), true);
  assert.equal(uiStyles.includes(".approval-final-inspection-panel"), true);
  assert.equal(uiStyles.includes(".approval-final-inspection-card"), true);
  assert.equal(uiStyles.includes(".approval-final-inspection-actions"), true);
  assert.equal(uiStyles.includes(".approval-connection-review-panel"), true);
  assert.equal(uiStyles.includes(".approval-connection-review-button"), true);
  assert.equal(uiStyles.includes(".approval-connection-review-actions"), true);
  assert.equal(uiStyles.includes(".approval-state-snapshot"), true);
  assert.equal(uiStyles.includes(".approval-state-import"), true);
  assert.equal(uiStyles.includes(".approval-state-file"), true);
  ...
  assert.equal(approvalHtml.includes("/pm01-approval.js?v=1.0.28"), true);
  assert.equal(uiHtml.includes("/pm01.js?v=1.0.29"), true);
  assert.equal(uiHtml.includes("/pm01.css?v=1.0.55"), true);
  ...
  assert.equal(uiScript.includes("activeCockpitFamilyId"), true);
  assert.equal(uiScript.includes("DIGITAL_SHIFT_PROGRESS_STORAGE_KEY"), true);
  assert.equal(uiScript.includes("setCockpitFamilyComplete"), true);
  assert.equal(uiScript.includes("completeAnsweredPracticeFamily"), true);
  assert.equal(uiScript.includes("renderDigitalShiftResultSummary"), true);
  assert.equal(uiScript.includes("answeredPracticeFamiliesForAttempt"), true);
  assert.equal(uiScript.includes("renderDigitalShiftProgressMeter"), true);
  assert.equal(uiScript.includes("renderCockpitFocus"), true);
  assert.equal(uiScript.includes("activeCockpitJournalEntries"), true);
  const server = fs.readFileSync(path.join(__dirname, "..", "server.js"), "utf8");
  assert.equal(server.includes("body.practiceFamily"), true);
  assert.equal(server.includes("question.practiceFamily === practiceFamily"), true);
  ...
  assert.equal(approvalScript.includes("buildShopApprovalPackageText"), true);
  assert.equal(approvalScript.includes("buildAllShopApprovalPackagesText"), true);
  assert.equal(approvalScript.includes("copyShopApprovalPackage"), true);
  assert.equal(approvalScript.includes("copyAllShopApprovalPackages"), true);
  assert.equal(approvalScript.includes("downloadShopApprovalPackage"), true);
  assert.equal(approvalScript.includes("downloadAllShopApprovalPackages"), true);
  assert.equal(approvalScript.includes("renderShopApprovalPackagePanel"), true);
  assert.equal(approvalScript.includes("renderAllShopPackagesPanel"), true);
  ...
  assert.equal(approvalScript.includes("PM01_COMPETENCY_REVIEW_STORAGE_KEY"), true);
  assert.equal(approvalScript.includes("COMPETENCY_REVIEW_ITEMS"), true);
  assert.equal(approvalScript.includes("renderCompetencyReviewPanel"), true);
  assert.equal(approvalScript.includes("buildCompetencyReviewReport"), true);
  assert.equal(approvalScript.includes("copyCompetencyReviewReport"), true);
  assert.equal(approvalScript.includes("competency_review"), true);
  assert.equal(approvalScript.includes("PM01_INNOVATION_REVIEW_STORAGE_KEY"), true);
  assert.equal(approvalScript.includes("INNOVATION_REVIEW_OPTIONS"), true);
  assert.equal(approvalScript.includes("renderInnovationReviewPanel"), true);
  ...
  assert.equal(approvalScript.includes("getPackageNextAction"), true);
  assert.equal(approvalScript.includes("copyActionPlan"), true);
  assert.equal(approvalScript.includes("renderActionPlan"), true);
  assert.equal(approvalScript.includes("buildRpRequestKitText"), true);
  assert.equal(approvalScript.includes("copyRpRequestKit"), true);
  assert.equal(approvalScript.includes("downloadRpRequestKit"), true);
  assert.equal(approvalScript.includes("renderRpRequestKitPanel"), true);
  assert.equal(approvalScript.includes("pm01-px-rp-ktp-request"), true);
  assert.equal(approvalScript.includes("text/markdown"), true);
  assert.equal(approvalScript.includes("REQUIRED_PM01_COMPETENCIES"), true);
  assert.equal(approvalScript.includes("buildCoverageAudit"), true);
  assert.equal(approvalScript.includes("buildCoverageAuditText"), true);
  assert.equal(approvalScript.includes("copyCoverageAudit"), true);
  assert.equal(approvalScript.includes("renderCoverageAuditPanel"), true);
  assert.equal(approvalScript.includes("ОК 09"), true);
  assert.equal(approvalScript.includes("ОК 10"), true);
  assert.equal(approvalScript.includes("buildPreviewBatchText"), true);
  assert.equal(approvalScript.includes("copyPreviewBatch"), true);
  ...
  assert.equal(approvalScript.includes("PM01_FINAL_ASSET_INSPECTION_STORAGE_KEY"), true);
  ...
  assert.equal(approvalScript.includes("renderPreviewInspectionPanel"), true);
  assert.equal(approvalScript.includes("buildFinalAssetInspectionReport"), true);
  assert.equal(approvalScript.includes("copyFinalAssetInspectionReport"), true);
  assert.equal(approvalScript.includes("renderFinalAssetInspectionPanel"), true);
  assert.equal(approvalScript.includes("final_visual_inspection"), true);
  assert.equal(approvalScript.includes("connection_review"), true);
  assert.equal(approvalScript.includes("PM01_CONNECTION_REVIEW_STORAGE_KEY"), true);
  assert.equal(approvalScript.includes("CONNECTION_REVIEW_OPTIONS"), true);
  assert.equal(approvalScript.includes("buildConnectionReviewReport"), true);
  assert.equal(approvalScript.includes("copyConnectionReviewReport"), true);
  assert.equal(approvalScript.includes("renderConnectionReviewPanel"), true);
  assert.equal(approvalScript.includes("approved_connection"), true);
  assert.equal(approvalScript.includes("buildConnectionImplementationText"), true);
  assert.equal(approvalScript.includes("checkConnectionImplementationFiles"), true);
  assert.equal(approvalScript.includes("resolveFinalAssetPublicUrl"), true);
  assert.equal(approvalScript.includes("getPackageConnectionReadiness"), true);
  assert.equal(approvalScript.includes("getConnectionReadinessSummary"), true);
  assert.equal(approvalScript.includes("PM01_CONNECTION_FILE_CHECK_STORAGE_KEY"), true);
  assert.equal(approvalScript.includes("copyConnectionImplementationPackage"), true);
  assert.equal(approvalScript.includes("downloadConnectionImplementationPackage"), true);
  assert.equal(approvalScript.includes("renderConnectionImplementationPanel"), true);
  assert.equal(approvalScript.includes("renderConnectionImplementationAssetList"), true);
  assert.equal(approvalScript.includes("pm01-px-connection-implementation"), true);
  assert.equal(approvalScript.includes("fileCheckStatus"), true);
  assert.equal(approvalScript.includes("reachable_image"), true);
  assert.equal(approvalScript.includes("readyForManualCodeChange"), true);
  assert.equal(approvalScript.includes("Ready for manual code change"), true);
  assert.equal(approvalScript.includes("manualCodeChangeRequired: true"), true);
  assert.equal(approvalScript.includes("publicExamChanged: false"), true);
  assert.equal(approvalScript.includes("buildApprovalStateSnapshot"), true);
  assert.equal(approvalScript.includes("applyApprovalStateSnapshot"), true);
  assert.equal(approvalScript.includes("copyApprovalStateSnapshot"), true);
  assert.equal(approvalScript.includes("downloadApprovalStateSnapshot"), true);
  assert.equal(approvalScript.includes("downloadTextFile"), true);
  assert.equal(approvalScript.includes("FileReader"), true);
  assert.equal(approvalScript.includes("renderStateSnapshotPanel"), true);
  assert.equal(approvalScript.includes("pm01_px_approval_snapshot"), true);
  assert.equal(approvalScript.includes("accepted_preview"), true);
  assert.equal(approvalScript.includes("rejected_preview"), true);
  assert.equal(approvalScript.includes("preview_only_until_teacher_approval"), true);
  assert.equal(approvalScript.includes("refreshApprovalOverview"), true);
  assert.equal(approvalScript.includes("renderApprovalGates"), true);
  assert.equal(approvalScript.includes("getPackageGateRows"), true);
  assert.equal(approvalScript.includes("copyRpIntake"), true);
  assert.equal(approvalScript.includes("copyMethodicalMatrix"), true);
  assert.equal(approvalScript.includes("renderVisualAssetRubric"), true);
  ...
  assert.equal(approvalScript.includes("waiting_rp"), true);
  ...
  assert.equal(uiStyles.includes(".approval-asset-checklist"), true);
  assert.equal(uiStyles.includes(".approval-visual-rubric-panel"), true);
  assert.equal(uiStyles.includes(".approval-visual-rubric-card"), true);
  assert.equal(uiStyles.includes(".approval-decision-panel"), true);
  assert.equal(uiStyles.includes(".approval-decision-button"), true);
  assert.equal(uiStyles.includes(".approval-note"), true);
  assert.equal(uiStyles.includes(".approval-rp-intake"), true);
  assert.equal(uiStyles.includes(".approval-rp-text"), true);
  ...
  assert.equal(approvalDoc.includes("Запрос РП/КТП"), true);
  ...
  assert.equal(approvalDoc.includes("Final asset inspection"), true);
  assert.equal(approvalDoc.includes("Connection implementation package"), true);
  assert.equal(approvalDoc.includes("Check public files"), true);
  assert.equal(approvalDoc.includes("fileCheckStatus"), true);
  assert.equal(approvalDoc.includes("readyForManualCodeChange"), true);
  assert.equal(approvalDoc.includes("readinessBlockers"), true);
  assert.equal(approvalDoc.includes("manualCodeChangeRequired: true"), true);
  assert.equal(approvalDoc.includes("publicExamChanged: false"), true);
...
test("PM01 digital shift extension is training-only and keeps official scoring stable", () => {
  ...
  const visualModes = new Map([
    ...
    ["shift_investigation", "shift_investigation"],
  ...
  assert.equal(publicData.digitalShift.visualAssetRubric.acceptIf.length >= 5, true);
  ...
  assert.equal(
    publicData.digitalShift.interactionBlueprints.every(
      (blueprint) =>
        families.has(blueprint.familyId) &&
        blueprint.visualMode === visualModes.get(blueprint.familyId) &&
        blueprint.layout &&
        Array.isArray(blueprint.studentFlow) &&
        blueprint.studentFlow.length >= 3 &&
        blueprint.animation &&
        blueprint.implementation &&
        blueprint.uniqueness &&
        blueprint.assessment &&
        blueprint.approvalQuestion
    ),
    true
  );
  ...
  publicData.digitalShift.packages.forEach((packageData) => {
    ...
    assert.equal(
      packageData.methodicalMatrix.every(
        (row) =>
          families.has(row.familyId) &&
          row.rpTopic &&
          Array.isArray(row.competencies) &&
          row.competencies.length >= 3 &&
          row.examModule.includes("PX") &&
          row.currentQuestion &&
          row.newFormat &&
          row.visualAsset?.targetPath?.startsWith("/assets/pm01/generated/digital-shift/") &&
          row.visualAsset.finalAsset === false &&
          row.checkCriterion &&
    ...
    assert.equal(
      packageData.previewAssets.every(
        (asset) =>
          ...
          ["16:9", "4:3"].includes(asset.aspectRatio) &&
          asset.visualPurpose &&
          Array.isArray(asset.styleReferences) &&
          asset.styleReferences.length >= 2 &&
          asset.styleReferences.every((reference) => reference.label && reference.path?.startsWith("/assets/pm01/")) &&
...
test("PM01 teacher cabinet exposes exam controls and printable protocol", () => {
  ...
  assert.match(studentHtml, /pm01\.css\?v=1\.0\.55/);
  ...
  assert.match(adminHtml, /pm01\.css\?v=1\.0\.55/);
