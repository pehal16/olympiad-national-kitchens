...
async function main() {
  ...
  assert(student.text.includes("/pm01.css?v=1.0.42"), "/pm01.html does not include current CSS");
  ...
  assert(approval.text.includes("/pm01.css?v=1.0.42"), "/pm01-approval.html does not include current CSS");
  assert(approval.text.includes("/pm01-approval.js?v=1.0.15"), "/pm01-approval.html does not include current approval JS");
