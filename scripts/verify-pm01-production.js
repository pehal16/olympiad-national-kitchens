...
async function main() {
  ...
  assert(student.text.includes("/pm01.js?v=1.0.27"), "/pm01.html does not include current student JS");
  assert(student.text.includes("/pm01.css?v=1.0.33"), "/pm01.html does not include current CSS");
  ...
  assert(approval.text.includes("/pm01.css?v=1.0.33"), "/pm01-approval.html does not include current CSS");
