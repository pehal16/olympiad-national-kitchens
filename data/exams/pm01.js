  ...
  variants: [
    ...
    },
    {
      ...
      test: [
        ...
        single("poultry-t1-rabbit", "При распределении сырья по участкам выберите, где обрабатывать кролика в рамках ПМ.01.", [["a", "на участке птицы, дичи и кролика"], ["b", "на мясном участке без отдельной подготовки инвентаря"], ["c", "на рыбном участке с доской РС"], ["d", "на овощном участке после мойки корнеплодов"]], "a"),
