  ...
  variants: [
    ...
    },
    {
      ...
      test: [
        ...
        single("complex-t1-fish-place", "В комплексном заказе есть партия сырой рыбы. На какой участок ее направляют для механической обработки?", [["a", "в рыбный или мясорыбный цех"], ["b", "на овощной участок"], ["c", "в мясной цех без отдельного рыбного инвентаря"], ["d", "в зону упаковки готовых полуфабрикатов"]], "a"),
        single("complex-t1-veg-place", "Для распределения сырья по участкам выберите, куда направить овощи.", [["a", "в овощной цех"], ["b", "в рыбный цех"], ["c", "в мясной цех"], ["d", "в зону упаковки готовых полуфабрикатов"]], "a"),
