  ...
  variants: [
    ...
    },
    {
      ...
      test: [
        ...
        single("poultry-t1-rabbit", "При распределении сырья по участкам выберите, где обрабатывать кролика в рамках ПМ.01.", [["a", "на участке птицы, дичи и кролика"], ["b", "в кондитерском цехе"], ["c", "на рыбном участке"], ["d", "в зоне сухих круп"]], "a"),
