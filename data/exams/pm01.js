  ...
  variants: [
    {
      ...
      test: [
        ...
        single("veg-t1-storage", "Овощные полуфабрикаты нужно оставить на короткое время до дальнейшей работы. Какой способ размещения допустим?", [
          ["a", "нарезанные овощи оставить открытыми на 5 часов"],
          ["b", "положить овощи в чистую тару и накрыть влажной тканью"],
          ["c", "поставить очищенный картофель рядом с отходами"],
          ["d", "оставить зелень на полу у рабочего стола"]
        ], "b")
      ],
      calculation: [
        calculation(
    ...
    },
    {
      ...
      test: [
        ...
        single("fish-t1-storage", "Сформованные рыбные полуфабрикаты ждут тепловой обработки. Где их нужно держать, чтобы не нарушить безопасность?", [["a", "при комнатной температуре на столе"], ["b", "в холодильнике в чистой таре"], ["c", "на открытом столе без тары"], ["d", "около плиты для ускорения работы"]], "b"),
    ...
    },
    {
      ...
      test: [
        ...
        single("meat-t1-boning", "На обвалочном столе нужно отделить мякоть от костей. Какой нож выбирает студент?", [["a", "обвалочный нож"], ["b", "кондитерский нож"], ["c", "овощной нож"], ["d", "рыбочистку"]], "a"),
        single("meat-t1-musat", "Перед нарезкой мяса нож стал хуже резать. Для чего студент использует мусат на рабочем месте?", [["a", "для правки режущей кромки ножа"], ["b", "для варки мяса"], ["c", "для хранения фарша"], ["d", "для мытья досок"]], "a"),
        ...
        single("meat-t1-offal-fast", "В сменном задании есть печень, почки и язык. Почему эти субпродукты обрабатывают без задержки и держат под охлаждением?", [["a", "они относятся к особо скоропортящемуся сырью"], ["b", "они не требуют входного контроля"], ["c", "они хранятся дольше овощей при комнатной температуре"], ["d", "их можно оставлять на столе до конца смены"]], "a"),
        single("meat-t1-forbidden", "Студент работает с мясорубкой МИМ-82. Какое действие категорически запрещено, пока машина включена или подключена к сети?", [["a", "до включения проверить сборку и исправность"], ["b", "снимать решетку, нож или шнек у работающей машины"], ["c", "подавать мясо штатным толкателем"], ["d", "мыть снятые детали после отключения машины"]], "b"),
    ...
    },
    {
      ...
      competencies: ["ПК 1.1", "ПК 1.2", "ПК 1.4", "ОК 01", "ОК 02", "ОК 07"],
      test: [
        multiple("poultry-t1-quality", "При приемке тушек птицы студент проводит органолептическую оценку. Какие признаки нужно проверить?", [["a", "запах"], ["b", "цвет кожи и мышц"], ["c", "консистенция тканей"], ["d", "цвет маркировки лотка"]], ["a", "b", "c"]),
        ...
        single("poultry-t1-defrost", "Поступила партия замороженных тушек птицы. Где правильно организовать размораживание перед обработкой?", [["a", "в охлаждаемом помещении"], ["b", "около плиты"], ["c", "на полу у стола"], ["d", "в горячей воде без контроля"]], "a"),
        single("poultry-t1-after-gut", "После потрошения тушки перед разделкой нужно удалить остатки загрязнений. Какую операцию выполняют следующей?", [["a", "промывают тушку"], ["b", "кладут тушку рядом с отходами"], ["c", "оставляют тушку без охлаждения"], ["d", "смешивают птицу с овощами"]], "a"),
        bucket(
          "poultry-t1-products",
    ...
    },
    {
      ...
      test: [
        single("complex-t1-start", "Студент получил комплексный заказ на овощные, рыбные и мясные полуфабрикаты. С чего нужно начать работу?", [["a", "с выбора упаковки до проверки сырья"], ["b", "с проверки задания, сырья и готовности рабочего места"], ["c", "с нарезки без распределения по участкам"], ["d", "с расчета цены реализации"]], "b"),
        single("complex-t1-fish-place", "В комплексном заказе есть партия сырой рыбы. На какой участок ее направляют для механической обработки?", [["a", "в рыбный или мясорыбный цех"], ["b", "в кондитерский цех"], ["c", "в моечную для посуды"], ["d", "на склад готовой продукции"]], "a"),
