  ...
  variants: [
    {
      ...
      test: [
        ...
        single("veg-t1-calibration", "При приемке партии картофеля перед машинной очисткой выберите цель калибровки.", [
        ...
        single("veg-t1-gross", "В заявке на сырье выберите, какая масса считается «брутто».", [
          ["a", "масса готового блюда"],
          ["b", "масса отходов"],
          ["c", "масса необработанного сырья"],
          ["d", "масса продукта после очистки"]
        ], "c"),
        single("veg-t1-net", "После обработки овощей выберите, какая масса считается «нетто».", [
        ...
        single("veg-t1-recipe-book", "При расчете сырья по сборнику рецептур определите недопустимое действие студента.", [
        ...
        single("veg-t1-storage", "После обработки овощей выберите вариант хранения, который не нарушает санитарные требования.", [
    ...
    },
    {
      ...
      test: [
        single("fish-t1-groups", "При планировании обработки партии рыбы выберите правильную классификацию по способу обработки.", [
        ...
        single("fish-t1-ro1", "Для подготовки партии чешуйчатой рыбы выберите назначение рыбоочистительной машины РО-1.", [["a", "для нарезки овощей"], ["b", "для удаления чешуи"], ["c", "для измельчения мяса"], ["d", "для взвешивания рыбы"]], "b"),
        single("fish-t1-breading", "Перед жаркой порционного полуфабриката выберите технологическую цель панирования.", [["a", "для сохранения сочности и образования корочки"], ["b", "чтобы скрыть запах порчи"], ["c", "чтобы увеличить отходы"], ["d", "чтобы заменить тепловую обработку"]], "a"),
        sequence("fish-t1-cutlet", "Для рыбных котлет установите порядок приготовления котлетной массы.", [["fillet", "разделать на филе"], ["grind", "измельчить"], ["bread", "замочить хлеб"], ["mix", "соединить"], ["spice", "добавить соль/перец"], ["beat", "вымешать и выбить"]], ["fillet", "grind", "bread", "mix", "spice", "beat"]),
        single("fish-t1-storage", "После формования выберите место хранения рыбных полуфабрикатов до тепловой обработки.", [["a", "при комнатной температуре"], ["b", "в холодильнике"], ["c", "на открытом столе"], ["d", "около плиты"]], "b"),
        ...
        single("fish-t1-danger", "На рыбном участке выберите ситуацию, которая создает риск перекрестного загрязнения.", [["a", "рыба разделывается на специальной доске"], ["b", "отходы удаляются вовремя"], ["c", "рыба промывается холодной водой"], ["d", "сырая рыба лежит рядом с готовыми овощами"]], "d")
      ],
      calculation: [
    ...
    },
    {
      ...
      test: [
        multiple("meat-t1-raw", "При приемке сырья для мясного цеха выберите позиции, относящиеся к мясному сырью.", [["a", "говядина"], ["b", "свинина"], ["c", "баранина"], ["d", "капуста"]], ["a", "b", "c"]),
        ...
        single("meat-t1-boning", "Для отделения мяса от костей выберите нужный инструмент.", [["a", "обвалочный"], ["b", "кондитерский"], ["c", "овощной"], ["d", "рыбочистку"]], "a"),
        single("meat-t1-musat", "Перед нарезкой мяса выберите назначение мусата на рабочем месте.", [["a", "для правки ножей"], ["b", "для варки мяса"], ["c", "для хранения фарша"], ["d", "для мытья досок"]], "a"),
        multiple("meat-t1-mincer", "Перед сборкой МИМ-82 выберите основные элементы мясорубки.", [["a", "корпус"], ["b", "шнек"], ["c", "ножи и решетки"], ["d", "тестораскаточная лента"]], ["a", "b", "c"]),
        single("meat-t1-pusher", "При загрузке мяса в мясорубку выберите разрешенный способ подачи сырья.", [["a", "рукой"], ["b", "ножом"], ["c", "деревянным пестиком или толкателем"], ["d", "вилкой"]], "c"),
        multiple("meat-t1-offal", "При сортировке сырья выберите продукты, относящиеся к субпродуктам.", [["a", "печень"], ["b", "почки"], ["c", "язык"], ["d", "картофель"]], ["a", "b", "c"]),
        single("meat-t1-offal-fast", "При планировании смены выберите причину ускоренной обработки субпродуктов.", [["a", "они особо скоропортящиеся"], ["b", "они не имеют запаха"], ["c", "они не требуют проверки"], ["d", "их нельзя мыть"]], "a"),
        single("meat-t1-forbidden", "При эксплуатации оборудования выберите действие, которое запрещено выполнять.", [["a", "проверять исправность до включения"], ["b", "разбирать включенную машину"], ["c", "мыть детали после отключения"], ["d", "использовать толкатель"]], "b"),
        single("meat-t1-small", "Для заявки на полуфабрикаты выберите позицию, относящуюся к мелкокусковым.", [["a", "гуляш"], ["b", "антрекот"], ["c", "бифштекс натуральный"], ["d", "крупный кусок мяса для варки"]], "a")
      ],
      calculation: [
    ...
    },
    {
      ...
      competencies: ["ПК 1.1", "ПК 1.2", "ПК 1.4", "ОК 01", "ОК 02", "ОК 07"],
      test: [
        multiple("poultry-t1-quality", "При приемке тушек выберите признаки, по которым оценивают качество птицы.", [["a", "запах"], ["b", "цвет кожи и мышц"], ["c", "консистенция"], ["d", "цвет посуды"]], ["a", "b", "c"]),
        multiple("poultry-t1-defects", "При входном контроле выберите дефекты птицы, при которых сырье нельзя использовать.", [["a", "плесневение"], ["b", "позеленение"], ["c", "гниение"], ["d", "чистая сухая поверхность"]], ["a", "b", "c"]),
        single("poultry-t1-defrost", "Для подготовки партии тушек выберите правильное место размораживания птицы.", [["a", "в охлаждаемом помещении"], ["b", "около плиты"], ["c", "на полу"], ["d", "в горячей воде без контроля"]], "a"),
        single("poultry-t1-after-gut", "После потрошения птицы выберите следующую обязательную операцию.", [["a", "промывают тушку"], ["b", "кладут рядом с отходами"], ["c", "оставляют без охлаждения"], ["d", "смешивают с овощами"]], "a"),
        bucket(
          "poultry-t1-products",
        ...
        single("poultry-t1-pin", "При дообработке тушки выберите инструмент для удаления перьевых пеньков.", [["a", "пинцет"], ["b", "овощерезку"], ["c", "мясорыхлитель"], ["d", "сито"]], "a"),
        single("poultry-t1-storage", "При размещении полуфабрикатов из птицы выберите действие, которое нельзя выполнять.", [["a", "хранить в холодильнике"], ["b", "хранить рядом с готовыми продуктами без упаковки"], ["c", "соблюдать товарное соседство"], ["d", "использовать чистую тару"]], "b"),
        single("poultry-t1-rabbit", "При распределении сырья по участкам выберите группу, к которой относится кролик в рамках ПМ.01.", [["a", "мясное сырье"], ["b", "кондитерское сырье"], ["c", "нерыбное водное сырье"], ["d", "крупа"]], "a"),
        single("poultry-t1-smell", "При неприятном запахе у тушки выберите правильное действие студента.", [["a", "использовать быстрее"], ["b", "промыть и продолжить"], ["c", "не использовать, сообщить преподавателю"], ["d", "смешать с другим сырьем"]], "c"),
        single("poultry-t1-place", "Перед обработкой птицы выберите правильную организацию рабочего места.", [["a", "отдельное, чистое, с доской, ножами, лотками и ванной"], ["b", "любое свободное место"], ["c", "рядом с готовыми овощами"], ["d", "на полу"]], "a")
      ],
      calculation: [
    ...
    },
    {
      ...
      test: [
        single("complex-t1-start", "При получении комплексного заказа выберите первое действие студента.", [["a", "с упаковки"], ["b", "с проверки задания, сырья и рабочего места"], ["c", "с нарезки"], ["d", "с расчета стоимости после реализации"]], "b"),
        single("complex-t1-fish-place", "Для распределения сырья по участкам выберите, куда направить рыбу для обработки.", [["a", "в рыбный или мясорыбный цех"], ["b", "в кондитерский цех"], ["c", "в моечную посуды"], ["d", "в склад готовой продукции"]], "a"),
        single("complex-t1-veg-place", "Для распределения сырья по участкам выберите, куда направить овощи.", [["a", "в овощной цех"], ["b", "в рыбный цех"], ["c", "в мясной цех"], ["d", "в торговый зал"]], "a"),
        multiple("complex-t1-label", "Перед передачей полуфабриката на хранение выберите обязательные сведения маркировки.", [["a", "название"], ["b", "дата и время изготовления"], ["c", "условия хранения"], ["d", "любимое блюдо повара"]], ["a", "b", "c"]),
        single("complex-t1-neighbor", "При размещении сырья в холодильнике выберите верный смысл товарного соседства.", [["a", "правильное размещение продуктов при хранении"], ["b", "хранение всего сырья вместе"], ["c", "продажа продуктов соседнему цеху"], ["d", "одинаковая цена товаров"]], "a"),
        single("complex-t1-bad-raw", "При обнаружении недоброкачественного сырья выберите правильное действие.", [["a", "использовать в первую очередь"], ["b", "смешать с качественным"], ["c", "не использовать и сообщить ответственному лицу"], ["d", "замариновать"]], "c"),
        single("complex-t1-book", "Для определения нормы сырья и выхода по заказу выберите нужный нормативный документ.", [["a", "сборник рецептур"], ["b", "журнал посещаемости"], ["c", "расписание занятий"], ["d", "личный блокнот"]], "a"),
        multiple("complex-t1-fish-products", "В комплексном заказе выберите позиции, относящиеся к рыбным полуфабрикатам.", [["a", "порционные куски рыбы"], ["b", "рыбная котлетная масса"], ["c", "рыбные котлеты"], ["d", "гуляш из говядины"]], ["a", "b", "c"]),
        multiple("complex-t1-meat-products", "В комплексном заказе выберите позиции, относящиеся к мясным полуфабрикатам.", [["a", "гуляш"], ["b", "азу"], ["c", "ромштекс"], ["d", "соломка картофеля"]], ["a", "b", "c"]),
        single("complex-t1-safety", "При хранении готовой партии выберите ошибку, которая нарушает безопасность.", [["a", "продукты промаркированы"], ["b", "рыба, мясо и овощи хранятся раздельно"], ["c", "сырое мясо лежит рядом с готовыми полуфабрикатами"], ["d", "используются чистые лотки"]], "c")
      ],
      calculation: [
