...
function pilotWorks(courseIds, groupId) {
  ...
  return [
    ...
    {
      courseId: mdkCourseId, defaultGroupId: groupId, kind: "practice",
      title: "Практическая работа № 7. Ознакомление с механическим оборудованием для обработки рыбы",
      topic: "Ознакомление с механическим оборудованием для обработки рыбы",
      instructions: "Изучите назначение оборудования рыбного цеха и устройство РО-1М. Соотнесите машины и операции, восстановите безопасный порядок работы, заполните операционную карту и приложите подписанную схему рыбоочистительной машины.",
      estimatedMinutes: 180, defaultDueAt: addDays(14),
      blocks: [
        instruction("pz7-source", "Оборудование и принцип действия", [
          "РО-1М предназначена для механизированного удаления чешуи. Электродвигатель через гибкий вал передаёт вращение скребку-фрезе. Предохранительный кожух закрывает рабочую часть, а кронштейн фиксирует электродвигатель на столе.",
          "В крупных специализированных рыбных цехах применяют плавникорезку ПР-2 и головоотсекающую машину ГС-1. Для измельчения подготовленной мякоти без костей используют мясорубку или сменный механизм универсального привода.",
          "До пуска проверяют крепление машины, кабель, выключатель, гибкий вал, скребок и защитный кожух. При шуме, вибрации, запахе нагрева, повреждении кабеля или заклинивании машину останавливают. Очистку и разборку выполняют только после полной остановки и отключения от электросети."
        ].join("\n\n"), {
          keyPoints: [
            { title: "Назначение", text: "Каждую машину выбирают под конкретную операцию и допустимый вид сырья." },
            { title: "Передача движения", text: "Электродвигатель → гибкий вал → скребок-фреза." },
            { title: "Безопасность", text: "Проверка до пуска → работа с защитным кожухом → остановка и отключение до очистки." }
          ],
          controlPoints: [
            { title: "До пуска", text: "Машина закреплена, кабель и выключатель исправны, рабочий орган установлен, кожух находится на месте." },
            { title: "Во время работы", text: "Рука не приближается к вращающемуся скребку; гибкий вал не имеет резких перегибов." },
            { title: "При неисправности", text: "Машину немедленно остановить, отключить и сообщить ответственному лицу." }
          ],
          images: [
            { src: "/assets/learning/practices/pz7/mechanical-scaler.jpeg", alt: "Общий вид переносной механизированной рыбочистки", caption: "Механизированная рыбочистка — общий вид" },
            { src: "/assets/learning/practices/pz7/manual-scraper.jpeg", alt: "Ручной скребок для удаления чешуи с рыбы", caption: "Ручной скребок — сравнение способа обработки" },
            { src: "/assets/learning/practices/pz7/ro1m-scheme.png", alt: "Упрощённая схема рыбоочистительной машины РО-1М", caption: "РО-1М — упрощённая схема" },
            { src: "/assets/learning/practices/pz7/ro1m-construction.gif", alt: "Подробная схема основных узлов рыбоочистительной машины РО-1М", caption: "РО-1М — схема узлов" }
          ]
        }),
        {
          id: "pz7-equipment", type: "matching", title: "Оборудование и технологическая операция",
          prompt: "Перетащите назначение к соответствующему оборудованию.", maxScore: 15, allowTargetReuse: false,
          leftItems: [
            { id: "ro1m", label: "Рыбоочистительная машина РО-1М", src: "/assets/learning/practices/pz7/ro1m-scheme.png", alt: "Схема РО-1М" },
            { id: "pr2", label: "Плавникорезка ПР-2" },
            { id: "gs1", label: "Головоотсекающая машина ГС-1" },
            { id: "grinder", label: "Мясорубка или сменный механизм" }
          ],
          rightItems: [
            { id: "remove-scales", label: "Удаление чешуи" },
            { id: "remove-fins", label: "Удаление плавников" },
            { id: "remove-heads", label: "Отделение голов" },
            { id: "mince-fillet", label: "Измельчение подготовленной мякоти без костей" }
          ],
          hints: [
            "Сопоставляйте название рабочего органа или машины с результатом операции.",
            "Мясорубку используют не для целой рыбы, а после получения подготовленной мякоти без костей."
          ],
          privateKey: { pairs: {
            ro1m: "remove-scales", pr2: "remove-fins", gs1: "remove-heads", grinder: "mince-fillet"
          } }
        },
        {
          id: "pz7-parts", type: "matching", title: "Узлы РО-1М и их функции",
          prompt: "Соотнесите каждый узел машины с его основной функцией.", maxScore: 20, allowTargetReuse: false,
          leftItems: [
            { id: "cutter", label: "Скребок-фреза" },
            { id: "guard", label: "Предохранительный кожух" },
            { id: "handle", label: "Рукоятка из электроизоляционного материала" },
            { id: "shaft", label: "Гибкий вал в защитном рукаве" },
            { id: "motor", label: "Электродвигатель" },
            { id: "bracket", label: "Кронштейн" }
          ],
          rightItems: [
            { id: "scale-contact", label: "Непосредственно снимает чешую зубьями рабочей поверхности" },
            { id: "guard-contact", label: "Ограничивает разлёт чешуи и доступ к вращающейся части" },
            { id: "hold-insulate", label: "Позволяет удерживать рабочую часть и обеспечивает электроизоляцию" },
            { id: "transmit", label: "Передаёт вращение от двигателя к скребку" },
            { id: "drive", label: "Создаёт вращательное движение" },
            { id: "fix", label: "Надёжно закрепляет двигатель на производственном столе" }
          ],
          hints: [
            "Проследите передачу движения по схеме: двигатель, гибкий вал, скребок.",
            "Кожух и рукоятка выполняют разные защитные функции: ограждение рабочей части и электроизоляция."
          ],
          privateKey: { pairs: {
            cutter: "scale-contact", guard: "guard-contact", handle: "hold-insulate",
            shaft: "transmit", motor: "drive", bracket: "fix"
          } }
        },
        {
          id: "pz7-order", type: "ordering", title: "Безопасная последовательность работы с РО-1М",
          prompt: "Перетащите действия в порядке от подготовки рабочего места до санитарной обработки машины.", maxScore: 15,
          items: [
            { id: "clean-parts", label: "Снять разрешённые части, вымыть, высушить и установить их по инструкции" },
            { id: "inspect-machine", label: "При отключённой машине проверить крепление, кабель, выключатель, гибкий вал, скребок и кожух" },
            { id: "stop-machine", label: "По окончании работы выключить машину" },
            { id: "prepare-place", label: "Подготовить чистое рабочее место и санитарную одежду" },
            { id: "process-fish", label: "Удерживая рыбу за хвост, вести скребок от хвоста к голове, не приближая руку к рабочему органу" },
            { id: "disconnect", label: "Отключить машину от электросети и дождаться полной остановки" },
            { id: "idle-check", label: "Включить машину и проверить работу на холостом ходу" },
            { id: "prepare-flow", label: "Разместить доску, сырьё, ёмкость для отходов и чистую тару" }
          ],
          hints: [
            "Осмотр узлов выполняют до подключения и пуска машины.",
            "Санитарная обработка начинается только после выключения, отключения от сети и полной остановки."
          ],
          privateKey: { order: [
        ...
        {
          id: "pz7-safety", type: "classification", title: "Контроль безопасности РО-1М",
          prompt: "Распределите действия и признаки по правильному этапу безопасной работы.", maxScore: 15,
          items: [
            { id: "mount", label: "Проверить крепление электродвигателя к столу" },
            { id: "cable", label: "Осмотреть кабель и выключатель" },
            { id: "guard", label: "Убедиться, что защитный кожух установлен" },
            { id: "tail", label: "Удерживать рыбу за хвостовой плавник" },
            { id: "direction", label: "Перемещать скребок от хвоста к голове" },
            { id: "hand-distance", label: "Не приближать руку к вращающемуся скребку" },
            { id: "noise", label: "Появились необычный шум или сильная вибрация" },
            { id: "heat", label: "Появился запах нагрева" },
            { id: "jam", label: "Рабочий орган заклинило" },
            { id: "remove", label: "Снять разрешённые для санитарной обработки детали" },
            { id: "wash", label: "Вымыть и высушить снятые детали" },
            { id: "clean-body", label: "Очистить наружные поверхности предусмотренным инструкцией способом" }
          ],
          categories: [
            { id: "before", label: "До пуска — проверить" },
            { id: "during", label: "Во время работы — соблюдать" },
            { id: "emergency", label: "Немедленно остановить и сообщить" },
            { id: "after", label: "Только после полной остановки и отключения" }
          ],
          hints: [
            "Признаки ненормальной работы нельзя оставлять до планового окончания операции.",
            "Любое действие у рабочего органа выполняют после полной остановки и отключения машины."
          ],
          privateKey: { assignments: {
            mount: "before", cable: "before", guard: "before",
            tail: "during", direction: "during", "hand-distance": "during",
            noise: "emergency", heat: "emergency", jam: "emergency",
            remove: "after", wash: "after", "clean-body": "after"
          } }
        },
        {
          id: "pz7-card", type: "table", title: "Операционная карта РО-1М",
          prompt: "Заполните карту краткими техническими формулировками. Для каждого пункта укажите действие или устройство и проверяемый признак.",
          rowHeader: "Пункт карты", maxScore: 20, calculator: false,
          worksheet: {
            eyebrow: "Основной объект", title: "Рыбоочистительная машина РО-1М",
            facts: [
              { label: "Операция", value: "удаление чешуи" },
              { label: "Передача движения", value: "электродвигатель → гибкий вал → скребок" },
              { label: "Главное правило", value: "очистка только после отключения" }
            ]
          },
          rows: [
            { id: "purpose", label: "1. Назначение и допустимое сырьё" },
            { id: "units", label: "2. Основные узлы" },
            { id: "working-part", label: "3. Рабочий орган и принцип действия" },
            { id: "precheck", label: "4. Проверка перед пуском" },
            { id: "operation", label: "5. Безопасный приём работы" },
            { id: "abnormal", label: "6. Признаки ненормальной работы" },
            { id: "shutdown", label: "7. Остановка и отключение" },
            { id: "sanitation", label: "8. Санитарная обработка" }
          ],
          columns: [
            { id: "action", label: "Устройство или действие", type: "textarea", rows: 2, required: true, placeholder: "Что устроено или что делает повар" },
            { id: "control", label: "Что проверить", type: "textarea", rows: 2, required: true, placeholder: "Наблюдаемый признак или условие безопасности" }
          ],
          hints: [
            "В пункте об узлах перечислите не менее пяти элементов, показанных на схеме.",
            "Для ненормальной работы назовите минимум три признака и одно правильное действие.",
            "В санитарной обработке обязательно укажите отключение от сети, полную остановку, мойку и сушку разрешённых деталей."
          ]
        },
        {
          id: "pz7-file", type: "file_evidence", title: "Подписанная схема РО-1М",
          prompt: "Приложите выполненную вами схему РО-1М. Подпишите скребок, кожух, рукоятку, гибкий вал, электродвигатель и кронштейн; стрелкой покажите передачу движения.",
          required: true, maxScore: 15, minFiles: 1, maxFiles: 1, maxFileBytes: 10_000_000,
          allowedMimeTypes: ["application/pdf", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "image/jpeg", "image/png"],
          allowedExtensions: ["pdf", "docx", "jpg", "jpeg", "png"],
          hints: [
            "Можно приложить PDF, DOCX или чёткую фотографию рисунка; все шесть подписей должны читаться.",
            "Стрелка передачи движения должна идти от электродвигателя через гибкий вал к скребку."
          ]
        }
      ],
      rubric: [
        { title: "Операционная карта РО-1М", description: "Восемь пунктов заполнены технически точно; указаны наблюдаемые проверки и безопасные действия.", maxScore: 20 },
        { title: "Подписанная схема", description: "Шесть основных узлов подписаны, а направление передачи движения показано верно и читаемо.", maxScore: 15 }
      ]
    }
  ];
}
