...
- Current platform package version: `1.6.91`; the learning pilot contains seven source-faithful МДК 01.01 practical works and does not change the official PM01 100-point contract.
...
- Content revisions are now per work: 7 for practices 1–3, 6 for 4–7. Pilot reseeding compares the desired definition revision for each work, not a global revision. Lifecycle tests verify selective upgrade, idempotence, retained accepted grade/answers and unchanged assignments/versions for 4–7.
