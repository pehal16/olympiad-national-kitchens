...
- Current platform package version: `1.6.92`; the learning pilot contains seven source-faithful МДК 01.01 practical works and does not change the official PM01 100-point contract.
